var arrLang = {
    ...
    "ro": {
        ...
        "VISION_03": "Urmarind o schimbare in structura sistemului de transfer de bani, noi propunem de asemenea o mutatie la nivelul relatiilor interpersonale.", // Aiming for a shift in the core structure of our money remittance systems, we also seek a change in the way we engage and commit to one another.
        ...
        "VALUES_22": "MigrantCoin isi propune sa fie accesibi pentru orice utilizator oriunde in lume. Acest proces in sine, este unul foarte complex si de durata, pe care noi singuri nu il putem finaliza. De aceea, veti fi multumiti sa aflati ca, in tarile in care ne oferim serviciile, si voi puteti deveni partenerii nostri.", // MigrantCoin is a project aiming to make its services available across the world. This is a very difficult and complex process we alone cannot complete. For this reason, you will be happy to know that, in the countries where we will offer our services, you too can become our partner.
